...
INP=$UPATH/src/StandAlone/inputs/PhaseField/heat/cn_sstruct_conv

for LD in $LDs; do
echo $LD
	for UPS in $INP/cn_sstruct_conv_%(solver)s_2d_nlvl*_%(ph)d_*.ups; do
...
NAME = "cn_sstruct_conv_%(solver)s_2d_np%(np)d"
