...
#LIST: BENCHTEST HEATTEST HEATMPITEST HEATBCTEST HEATBCMPITEST HEATAMRTEST HEATAMRMPITEST HEATAMRBCTEST HEATAMRBCMPITEST HEATHYPRETEST HEATHYPREBEMPITEST HEATHYPRECNMPITEST HEATHYPREAMRTEST HEATHYPREAMRMPITEST HEATHYPREAMRBC2DBETEST HEATHYPREAMRBC2DCNTEST HEATHYPREAMRBC3DTEST HEATHYPREAMRBCMPITEST HEATHYPREFACTEST HEATHYPREFACMPITEST HEATHYPREFACBCTEST HEATHYPREFACBCMPITEST PUREMETALTEST PUREMETALMPITEST PUREMETALAMRCCTEST PUREMETALAMRNCTEST PUREMETALAMRMPITEST
...
def getTestList(me) :
  if me == "BENCHTEST":
    ...
    TESTS = HEATHYPRECNMPITEST + HEATHYPREAMRBC2DBETEST + HEATHYPREAMRBC2DCNTEST + HEATHYPREAMRBC3DTEST + HEATHYPREAMRBCMPITEST + HEATHYPREFACTEST + HEATHYPREFACMPITEST + HEATHYPREFACBCTEST + HEATHYPREFACBCMPITEST + PUREMETALAMR2DMPITEST

  elif me == "LOCALTESTS":
    TESTS = BENCHTEST + HEATMPITEST + HEATBCMPITEST + HEATAMRMPITEST + HEATAMRBCTEST + HEATAMRBCMPITEST + HEATHYPRETEST + HEATHYPREMPITEST + HEATHYPREAMRTEST + HEATHYPREAMRMPITEST + PUREMETALTEST + PUREMETALMPITEST + PUREMETALAMRTEST + PUREMETALAMR3DMPITEST
