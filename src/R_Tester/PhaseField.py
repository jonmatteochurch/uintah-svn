...
def getTestList(me) :
  if me == "BENCHTEST":
    ...
    TESTS = HEATHYPREFACTEST + HEATHYPREFACMPITEST + HEATHYPREFACBCTEST + HEATHYPREFACBCMPITEST + PUREMETALAMR2DMPITEST

  elif me == "LOCALTESTS":
    TESTS = BENCHTEST + HEATMPITEST + HEATBCMPITEST + HEATAMRMPITEST + HEATAMRBCTEST + HEATAMRBCMPITEST + HEATHYPRETEST + HEATHYPREMPITEST + HEATHYPREAMRTEST + HEATHYPREAMRMPITEST + HEATHYPREAMRBCTEST + HEATHYPREAMRBCMPITEST + PUREMETALTEST + PUREMETALMPITEST + PUREMETALAMRTEST + PUREMETALAMR3DMPITEST
